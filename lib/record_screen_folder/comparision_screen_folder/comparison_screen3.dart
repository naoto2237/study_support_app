...
class ComparisonScreen3 extends StatefulWidget {
  ...
  @override
  State<ComparisonScreen3> createState() => _ComparisonScreen3State();
}

class _ComparisonScreen3State extends State<ComparisonScreen3> {
          ...
          content: Column(
            ...
            children: [
              ListTile(
                ...
                onTap: () {
                  widget.onComparisonTargetChanged(
                    "全体のユーザー（平均）",
                  );
